...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "space",     function () awful.util.spawn("rofi -modi drun -show drun -show-emoji -line") end,
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,			  }, "k",  awful.client.floating.toggle                     ,
...
for i = 1, 5 do
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key({ modkey, "Mod1", "Shift" }, "#" .. i + 5,
                  function ()
                      if client.focus then
                          local tag = client.focus.screen.tags[i]
                          if tag then
